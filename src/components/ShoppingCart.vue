  ...
  <div>
      ...
      <div class="add-info-box">
        <div class="add-info-detail">
          <div class="add-info-title">
            <p>
              <i class="fa fa-check-circle"></i> {{ $t('shoppingCart.addedSuccess') }}</p>
          </div>
          <div class="add-info-box-row">
            ...
            <div class="add-info-intro">
              ...
              <p class="add-info-intro-detail">
                {{ $t('shoppingCart.color') }}：{{newShoppingCart.package.intro}}/
                {{ $t('shoppingCart.count') }}：{{newShoppingCart.count}}
              </p>
            </div>
          </div>
        </div>
        <div class="car-btn-group">
          ...
          <div class="car-btn-row">
            <router-link to="/goodsDetail">
              <button class="btn-car btn-car-to-detail">{{ $t('shoppingCart.viewDetail') }}</button>
            </router-link>
            <router-link to="/order">
              <button class="btn-car btn-car-to-pay">{{ $t('shoppingCart.goToPay') }}</button>
            </router-link>
          </div>
        </div>
      </div>
    ...
    <div class="other-user-buy-box">
      <div class="other-user-buy-title">
        <p>{{ $t('shoppingCart.recommendTitle') }}</p>
      </div>
        ...
        <div class="other-user-buy-item-box" v-for="(item,index2) in items" :key="index2">
          ...
          <div class="other-buy-detail-box">
            ...
            <div class="other-buy-btn-box">
              <router-link to="/goodsDetail">
                <button class="other-buy-btn"><Icon type="ios-cart"></Icon> {{ $t('shoppingCart.addToCart') }}</button>
              </router-link>
            </div>
          </div>
        </div>
